...
interface DistrictsSidebarProps {
    selectedDistrict: DistrictPolygon | null;
    currentYear: number;
    onClose: () => void;
}
            ...
            <div className="p-5 flex-1 overflow-y-auto">
                <div className="mb-6 text-center">
                    ...
                    {selectedDistrict.mainSymbol && (
                        <div className="inline-block px-3 py-1 bg-ink/5 rounded-full text-xs font-bold text-ink border border-ink/10">
                            {selectedDistrict.mainSymbol}
                        </div>
                    )}
                </div>
                ...
                {selectedDistrict.description && (
                    <div className="mb-6">
                        <h4 className="text-[10px] uppercase font-bold text-ink-light mb-2 flex items-center gap-1">
                            <Info size={12} /> Historical Context
                        </h4>
                ...
                {selectedDistrict.gonfaloni && selectedDistrict.gonfaloni.length > 0 && (
                    <div>
                        <h4 className="text-[10px] uppercase font-bold text-ink-light mb-3 flex items-center gap-1">
                            <Flag size={12} /> Gonfaloni (Companies)
                        </h4>
